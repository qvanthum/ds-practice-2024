...
class SuggestionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ClearData = channel.unary_unary(
                '/bookstore.SuggestionService/ClearData',
                request_serializer=order__pb2.OrderInfo.SerializeToString,
...
class SuggestionServiceServicer(object):
    ...
    def InitSuggestBooks(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_SuggestionServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'bookstore.SuggestionService', rpc_method_handlers)
...
class SuggestionService(object):
    ...
    def SuggestBooks(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bookstore.SuggestionService/SuggestBooks',
    ...
    def ClearData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bookstore.SuggestionService/ClearData',
            order__pb2.OrderInfo.SerializeToString,
